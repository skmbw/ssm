...
public class ObjectId implements Comparable<ObjectId> , java.io.Serializable {
    ...
    static final Logger LOGGER = LoggerFactory.getLogger( "org.bson.ObjectId" );
     ...
     */
    @Deprecated
    private ObjectId( Date time , int machine , int inc ){
     ...
     */
    @Deprecated
    private ObjectId(int time, int machine, int inc) {
        _time = time;
        _machine = machine;
        _inc = inc;
        _new = false;
