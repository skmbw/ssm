...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        method = new Method();
        method.addJavaDocLine("获得逻辑or语句");
        method.setVisibility(JavaVisibility.PUBLIC);
        ...
        method = new Method();
        method.addJavaDocLine("添加逻辑or语句");
        method.setVisibility(JavaVisibility.PUBLIC);
        ...
        method = new Method();
        method.addJavaDocLine("新建逻辑或or语句");
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("or"); //$NON-NLS-1$
        ...
        method = new Method();
        method.addJavaDocLine("创建查询条件，如果逻辑或为空，同时将查询条件放入。");
        method.setVisibility(JavaVisibility.PUBLIC);
